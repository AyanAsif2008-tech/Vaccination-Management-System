  ...
  <div class="login-form-side">
    <div class="login-form-box">
      ...
      <div class="credentials" style="font-size: 13px; text-align: center;">
        ...
        <p>Parent credential <span style="font-weight: bolder; color: var(--slate)">tariq@gmail.com/tariq123</span></p>
        <p>Hospital credential <span style="font-weight: bolder; color: var(--slate)">liaquat@gmail.com/liaquat234</span></p>
      </div>
    </div>
  </div>
