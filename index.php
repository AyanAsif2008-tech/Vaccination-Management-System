...
<head>
  ...
  <meta name="description" content="Vaccination System connects parents, hospitals, and administrators on one platform to schedule, approve, and track childhood vaccinations.">
  ...
  <style>
    ...
    .lp-nav.scrolled {
      background: radial-gradient(circle at 15% 8%, #123a6b5a 0%, var(--ink, #0b192c) 48%, #04101F 100%);
    ...
    .lp-hero {
      position: relative;
      overflow: hidden;
      background: radial-gradient(circle at 15% 8%, #1a6ed3 0%, var(--ink) 48%, #04101F 100%);
    ...
    .lp-step-num {
      ...
      position: relative;
      z-index: 2;
      box-shadow: 0 8px 20px -8px rgba(18, 40, 60, .4);
      transition: transform .2s ease;
    }
    ...
    .lp-portals {
      background: radial-gradient(circle at 15% 8%, rgb(39, 119, 216) 0%, var(--ink, #0b192c) 48%, #04101F 100%);
      position: relative;
      overflow: hidden;
    }
    ...
    .lp-portals::before {
      ...
      height: 360px;
      border-radius: 50%;
      border: 1px dashed rgba(56, 189, 248, .16);
      top: -120px;
      right: -100px;
      animation: floatSlow 10s ease-in-out infinite;
    }

    .lp-portals .lp-section-title,
    .lp-portals .lp-section-tag {
      color: #fff;
    }
    ...
    .lp-role-card .btn-portal:hover {
      background: #0088cc;
    }

    .lp-role-card .btn-admin {
      background: #0b192c;
    }

    .lp-role-card .btn-admin:hover {
      background: #152844;
    }
  ...
  <nav class="lp-nav" id="lpNav">
    <div class="lp-nav-inner">
      <a href="#top" class="lp-nav-brand">
        <div class="logo">
          <img src="./assets/media/Logo.png" alt="" style="width: 150px;">
        </div>
      </a>
      ...
      <div class="lp-nav-right">
        <a href="login.php" class="btn btn-outline btn-sm lp-nav-cta">Login</a>
  ...
  <section class="lp-section lp-features" id="features">
    <div class="lp-section-inner">
      <div class="lp-section-head reveal">
        <span class="lp-section-tag">Why Our System</span>
  ...
  <section class="lp-section lp-portals" id="portals">
    <div class="lp-section-inner">
      <div class="lp-section-head reveal">
        ...
        <p class="lp-section-sub">Sign up as a parent or a hospital to get started administrators sign in from the Login button above.</p>
      </div>
      ...
      <div class="lp-role-grid">
        <div class="lp-role-card reveal reveal-delay-1">
          ...
          <h3>Parent Registeration</h3>
          <p>Register your children, schedule vaccination slots, and access official immunization cards.</p>
          <a href="parent/register.php" class="btn-portal">Sign Up <i class="fa-solid fa-arrow-right"></i></a>
        </div>
        ...
        <div class="lp-role-card reveal reveal-delay-2">
          ...
          <a href="hospital/register.php" class="btn-portal">Sign Up <i class="fa-solid fa-arrow-right"></i></a>
        </div>
      </div>
    </div>
  </section>
