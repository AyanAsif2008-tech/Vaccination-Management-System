...
// Count hospitals awaiting approval, shown as a notification badge on "Hospitals" below.
$pendingHospitalsCount = $pdo->query("SELECT COUNT(*) FROM hospital WHERE Status = 'Pending'")->fetchColumn();
...
<title><?= isset($pageTitle) ? e($pageTitle) . ' · ' : '' ?>VMS Admin Portal</title>
...
<div class="app-shell">
  ...
  <aside class="sidebar" id="sidebar">
    <div class="sidebar-brand">
      ...
      <div class="brand-word">Admin Portal<small>Vacci Track</small></div>
    </div>
    ...
    <nav class="sidebar-nav">
      ...
      <a href="hospitals.php" class="nav-link <?= navActive('hospitals.php', $current) ?>" title="Hospitals">
        <i class="fa-solid fa-hospital"></i> <span class="nav-text">Hospitals</span>
        <?php if (!empty($pendingHospitalsCount)): ?>
          <span class="nav-badge"><?= (int)$pendingHospitalsCount ?></span>
        <?php endif; ?>
      </a>
    ...
    <div class="sidebar-foot">Vaccination Management System<br>  Admin Panel</div>
  </aside>
  ...
  <div class="main-col">
    <header class="topbar">
      ...
      <div class="topbar-right">
        <a href="../index.php" class="btn btn-outline btn-sm no-print"><i class="fa-solid fa-house"></i> <span class="home-btn-text">Home</span></a>
        <div style="position:relative;">
          <div class="admin-chip" id="adminChip">
            ...
            <i class="fa-solid fa-chevron-down" style="font-size:11px;color:rgba(255,255,255,.75);margin-left:2px;"></i>
          </div>
