    ...
    <form method="POST" id="childForm">
      <div class="modal-body">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" name="child_name" id="childName" pattern="^(?=.*[A-Za-z])[A-Za-z\s'\-]{2,100}$" title="Enter a valid name (letters only, at least 2 characters)" required>
        </div>
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:14px;">
          ...
          <div class="form-group">
            ...
            <input type="date" class="form-control" name="dob" id="childDob" max="<?= date('Y-m-d') ?>" required>
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" name="address" id="childAddress" pattern="(?=.*[A-Za-z0-9]).{0,255}" title="Please enter a real address">
        </div>

        <div class="form-group">
          <label class="form-label">Notes</label>
          <textarea class="form-control" name="notes" id="childNotes" rows="2" placeholder="Allergies, medical notes, etc." style="resize: none;"></textarea>
        </div>
      </div>
