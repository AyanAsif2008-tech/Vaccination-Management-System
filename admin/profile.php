    ...
    <div class="card-panel-body">
      ...
      <form method="POST">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" name="name" value="<?= e($admin['Name']) ?>" pattern="^(?=.*[A-Za-z])[A-Za-z\s'\-]{2,100}$" title="Enter a valid name (letters only, at least 2 characters)" required>
        </div>
        <div class="form-group">
          <label class="form-label">Email</label>
          <input type="email" class="form-control" name="email" value="<?= e($admin['Email']) ?>" pattern="[A-Za-z0-9._%+\-]+@[A-Za-z0-9.\-]+\.[A-Za-z]{2,}" title="Enter a valid email address" required>
        </div>
        <div class="form-group">
          <label class="form-label">Username</label>
          <input type="text" class="form-control" name="username" value="<?= e($admin['Username']) ?>" pattern="^[A-Za-z0-9_]{3,30}$" title="3-30 characters: letters, numbers, and underscores only" required>
        </div>
        <div class="form-group">
