    ...
    <form method="POST" id="parentForm">
      <div class="modal-body">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" name="name" id="parentName" pattern="^(?=.*[A-Za-z])[A-Za-z\s'\-]{2,100}$" title="Enter a valid name (letters only, at least 2 characters)" required>
        </div>
        <div class="form-group">
          <label class="form-label">Email</label>
          <input type="email" class="form-control" name="email" id="parentEmail" pattern="[A-Za-z0-9._%+\-]+@[A-Za-z0-9.\-]+\.[A-Za-z]{2,}" title="Enter a valid email address" required>
        </div>
        <div class="form-group">
          <label class="form-label">Phone</label>
          <input type="tel" class="form-control" name="phone" id="parentPhone" pattern="(0[0-9]{10}|\+92[0-9]{10}|\+91[0-9]{10})" title="Enter an 11-digit number starting with 0 (e.g. 03001234567), or +92/+91 followed by 10 digits">
        </div>
        <div class="form-group">
          <label class="form-label">Username</label>
          <input type="text" class="form-control" name="username" id="parentUsername" pattern="^[A-Za-z0-9_]{3,30}$" title="3-30 characters: letters, numbers, and underscores only" required>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <textarea class="form-control" name="address" id="parentAddress" rows="2" style="resize: none;"></textarea>
        </div>
      </div>
