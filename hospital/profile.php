    ...
    <div class="card-panel-body">
      ...
      <form method="POST">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" name="hospital_name" value="<?= e($hospital['Hospital_Name']) ?>" pattern="^(?=.*[A-Za-z])[A-Za-z0-9\s.,'\-&]{2,150}$" title="Enter a valid hospital name (must contain letters)" required>
        </div>
        <div class="form-group">
          <label class="form-label">Location / City</label>
          <input type="text" class="form-control" name="location" value="<?= e($hospital['Location']) ?>" pattern="[A-Za-z\s,\-]{2,100}" title="City/region name: letters, spaces, commas and hyphens only">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <input type="tel" class="form-control" name="phone" value="<?= e($hospital['Phone']) ?>" pattern="(0[0-9]{10}|\+92[0-9]{10}|\+91[0-9]{10})" title="Enter an 11-digit number starting with 0 (e.g. 03001234567), or +92/+91 followed by 10 digits">
        </div>
        <div class="form-group">
          <label class="form-label">Email</label>
          <input type="email" class="form-control" name="email" value="<?= e($hospital['Email']) ?>" pattern="[A-Za-z0-9._%+\-]+@[A-Za-z0-9.\-]+\.[A-Za-z]{2,}" title="Enter a valid email address" required>
        </div>
