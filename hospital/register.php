    ...
    <div class="login-form-box">
      ...
      <form method="POST" action="register.php">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" name="hospital_name" value="<?= e($old['hospital_name']) ?>" pattern="^(?=.*[A-Za-z])[A-Za-z0-9\s.,'\-&]{2,150}$" title="Enter a valid hospital name (must contain letters)" required>
        </div>
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:14px;">
          ...
          <div class="form-group">
            ...
            <input type="tel" class="form-control" name="phone" value="<?= e($old['phone']) ?>" pattern="(0[0-9]{9,10}|\+92[0-9]{9,10})" title="Enter an 11-digit number starting with 0 (e.g. 03001234567), or +92/+91 followed by 10 digits">
          </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" name="location" value="<?= e($old['location']) ?>" pattern="[A-Za-z\s,\-]{2,100}" title="City/region name: letters, spaces, commas and hyphens only">
        </div>
        <div class="form-group">
