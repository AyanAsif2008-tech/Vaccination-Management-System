    ...
    <table class="data-table">
      ...
      <tbody>
        <?php if (!$bookings): ?>
          <tr>
            <td colspan="5">
              <div class="empty-state"><i class="fa-solid fa-calendar-check"></i>
    ...
    <form method="POST">
      <div class="modal-body">
        ...
        <div class="form-group">
          ...
          <textarea class="form-control" name="remarks" rows="3" placeholder="Any notes about the dose administered, reactions, etc." style="resize: none;"></textarea>
        </div>
      </div>
